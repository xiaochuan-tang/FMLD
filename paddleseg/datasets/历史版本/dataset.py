    ...
    def __init__(self,
        ...
        with open(file_path, 'r') as f:
            for line in f:
                ...
                label_path = os.path.join(self.dataset_root, items[3])

                self.file_list.append([image, opt, dem, label_path])

    def __getitem__(self, idx):
        # image_path, label_path = self.file_list[idx]
        image_path, opt, dem, label_path = self.file_list[idx]
        ...
        if self.mode == 'test':
            ...
            if self.edge:
                ...
                return im, opt, dem, label, edge_mask
            else:
                return im, opt, dem, label
