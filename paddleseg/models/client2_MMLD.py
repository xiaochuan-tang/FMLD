...
#         )
#
#     def forward(self, x11, x12, x21, x22):  # hill,opt,dem,sar
...
#                  pretrained=None
#                  ):
#         super(client2_MMLD, self).__init__()
...
#
#         dem_shape = [2, 64, 256, 256]
#
#         feat1 = F.interpolate(
#             dem_p[0], dem_shape[2:], mode="bilinear", align_corners=False)
#         feat2 = F.interpolate(
#             dem_p[1], dem_shape[2:], mode="bilinear", align_corners=False)
#         feat3 = F.interpolate(
#             dem_p[2], dem_shape[2:], mode="bilinear", align_corners=False)
#         dem_c = paddle.concat([feat1, feat2, feat3], axis=1)
#         dem_c = self.conv(dem_c)
#         # print("dem.shape:", dem_c.shape)  # dem.shape: [1, 64, 256, 256]
#
#         # dem = F.interpolate(
#         #     dem,
#         #     size=dem_shape[2:],
