...
class SegFormer_official(nn.Layer):
    """
    ...
    def __init__(self,
                 ...
                 align_corners=False,
                 pretrained=None):
        super(SegFormer_official, self).__init__()
...
@manager.MODELS.add_component
def SegFormer_B0_official(**kwargs):
    return SegFormer_official(
...
@manager.MODELS.add_component
def SegFormer_B1_official(**kwargs):
    return SegFormer_official(
...
@manager.MODELS.add_component
def SegFormer_B2_official(**kwargs):
    return SegFormer_official(
...
@manager.MODELS.add_component
def SegFormer_B3_official(**kwargs):
    return SegFormer_official(
...
@manager.MODELS.add_component
def SegFormer_B4_official(**kwargs):
    return SegFormer_official(
...
@manager.MODELS.add_component
def SegFormer_B5_official(**kwargs):
    return SegFormer_official(
