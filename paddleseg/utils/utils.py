        ...
        if os.path.splitext(image_path)[-1] in valid_suffix:
            ...
            with open(image_path, 'r') as f:
                ...
                for line in f:
                    ...
                    image = os.path.join(image_dir, items[0])
                    opt = os.path.join(image_dir, items[1])
                    dem = os.path.join(image_dir, items[2])
                    sar = os.path.join(image_dir, items[3])
                    label_path = os.path.join(image_dir, items[4])

                    image_list.append([image, opt, dem, sar])
