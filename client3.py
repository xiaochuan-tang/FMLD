...
from paddleseg.core import train_client3
...
def main_2(args, client):
    ...
    # model = cfg.model
    # utils.load_entire_model(model, "./output/pretrained/hrformer_base_hillshade.pdparams")
    # logger.info('Loaded trained params of model successfully')

    train_client3.train_2(
        cfg.model,
        train_dataset,
        client,
        val_dataset=val_dataset,
